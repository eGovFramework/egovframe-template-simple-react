    ...
    return (
        <>
            ...
            <Routes>
                ...
                <Route
                    path={URL.ABOUT}
                    element={<Navigate to={URL.ABOUT_SITE} replace />}
                />
                <Route path={URL.ABOUT_SITE} element={<EgovAboutSite />} />
                <Route
                    path={URL.ABOUT_HISTORY}
                    element={<EgovAboutHistory />}
                />
                <Route
                ...
                />
                <Route
                    path={URL.ABOUT_LOCATION}
                    element={<EgovAboutLocation />}
                />

                {/* INTRO */}
                <Route
                    path={URL.INTRO}
                    element={<Navigate to={URL.INTRO_WORKS} replace />}
                />
                <Route path={URL.INTRO_WORKS} element={<EgovIntroWork />} />
                <Route
                    path={URL.INTRO_SERVICE}
                    element={<EgovIntroService />}
                />
                ...
                <Route
                    path={URL.SUPPORT_QNA}
                    element={<EgovSupportQnaList />}
                />
                <Route
                ...
                <Route
                    path={URL.INFORM_GALLERY}
                    element={<EgovGalleryList />}
                />
                <Route
                ...
                />
                <Route
                    path={URL.ADMIN_SCHEDULE}
                    element={<EgovAdminScheduleList />}
                />
                <Route
                ...
                <Route
                    path={URL.ADMIN_BOARD}
                    element={<EgovAdminBoardList />}
                />
                <Route
                ...
                <Route
                    path={URL.ADMIN_USAGE}
                    element={<EgovAdminUsageList />}
                />
                <Route
                ...
                <Route
                    path={URL.ADMIN_NOTICE}
                    element={<EgovAdminNoticeList />}
                />
                <Route
                ...
                <Route
                    path={URL.ADMIN_GALLERY}
                    element={<EgovAdminGalleryList />}
                />
                <Route
                ...
                {/* 사이트관리자 암호 바꾸기 기능 */}
                <Route
                    path={URL.ADMIN_MANAGER}
                    element={<EgovAdminPasswordUpdate />}
                />
                <Route
                    path={URL.ADMIN_MEMBERS}
                    element={<EgovAdminMemberList />}
                />
                <Route
