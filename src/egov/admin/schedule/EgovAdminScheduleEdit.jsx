...
const EgovAdminScheduleEdit = (props) => {
  ...
  const updateSchedule = () => {
    ...
    for (const key in scheduleDetail) {
            ...
            <div className='board_view2'>
              ...
              <div className='board_btn_area'>
                <div className='left_col btn1'>
                  <button className='btn btn_skyblue_h46 w_100' onClick={() => updateSchedule()}>
                    {' '}
                    저장
                  </button>
                ...
                <div className='right_col btn1'>
                  <Link to={URL.ADMIN_SCHEDULE} className='btn btn_blue_h46 w_100'>
                    목록
                  </Link>
                </div>
              </div>
