        ...
        <div className='layout'>
          ...
          <div className='contents TEMPLATE_REG' id='contents'>
            ...
            <div className='board_view2'>
              <dl>
                <dt>
                  <label htmlFor='tmplatNm'>템플릿명</label>
                ...
                <dd>
                  <input
                    ...
                    id='tmplatNm'
                    placeholder=''
                    defaultValue={templateDetail.tmplatNm}
                  />
                </dd>
              </dl>
              <dl>
                <dt>
                  템플릿 구분<span className='req'>필수</span>
                </dt>
                <dd>
              ...
              <dl>
                <dt>
                  <label htmlFor='tmplatCours'>템플릿 경로</label>
                  <span className='req'>필수</span>
                </dt>
                <dd>
                  <input
                    ...
                    id='tmplatCours'
                    placeholder=''
                    defaultValue={templateDetail.tmplatCours}
                  />
                </dd>
              </dl>
              <dl>
                ...
                <dd>
                  ...
                  {/* <EgovRadioButton
                                    ...
                                    <EgovRadioButton
                                        ...
                                        setter={setUseAt} 
                                    /> */}
                  <EgovRadioButtonGroup name='useAt' radioGroup={useAtRadioGroup} setValue={useAt} setter={setUseAt} />
                </dd>
              </dl>
              ...
              <div className='board_btn_area'>
                ...
                <div className='right_col btn1'>
                  <a href='' className='btn btn_blue_h46 w_100'>
                    목록
                  </a>
                </div>
              </div>
