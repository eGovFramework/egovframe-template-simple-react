    ...
    <div className="header">
      <div className="inner">
        ...
        <div className="gnb">
          ...
          <ul>
            <li>
              <NavLink to={URL.ABOUT} activeClassName="cur">
                사이트소개
              </NavLink>
            </li>
            <li>
              <NavLink to={URL.INTRO} activeClassName="cur">
                정보마당
              </NavLink>
            </li>
            <li>
              <NavLink to={URL.SUPPORT} activeClassName="cur">
                고객지원
              </NavLink>
            </li>
            <li>
              <NavLink to={URL.INFORM} activeClassName="cur">
                알림마당
              </NavLink>
            </li>
            {loginUser?.id && (
              <li>
                <NavLink to={URL.ADMIN} activeClassName="cur">
                  사이트관리
                </NavLink>
              </li>
            )}
      ...
      <div className="all_menu WEB">
        ...
        <div className="inner">
          <div className="col">
            ...
            <ul>
              <li>
                <NavLink to={URL.ABOUT_SITE} activeClassName="cur">
                  소개
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.ABOUT_HISTORY} activeClassName="cur">
                  연혁
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.ABOUT_ORGANIZATION} activeClassName="cur">
                  조직소개
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.ABOUT_LOCATION} activeClassName="cur">
                  찾아오시는 길
                </NavLink>
              </li>
            </ul>
          ...
          <div className="col">
            ...
            <ul>
              <li>
                <NavLink to={URL.INTRO_WORKS} activeClassName="cur">
                  주요사업 소개
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.INTRO_SERVICE} activeClassName="cur">
                  대표서비스 소개
                </NavLink>
              </li>
            </ul>
          ...
          <div className="col">
            ...
            <ul>
              <li>
                <NavLink to={URL.SUPPORT_DOWNLOAD} activeClassName="cur">
                  자료실
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.SUPPORT_QNA} activeClassName="cur">
                  묻고 답하기
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.SUPPORT_APPLY} activeClassName="cur">
                  서비스 신청
                </NavLink>
              </li>
            </ul>
          ...
          <div className="col">
            ...
            <ul>
              ...
              <li>
                <NavLink to={URL.INFORM_WEEKLY} activeClassName="cur">
                  금주의 행사
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.INFORM_NOTICE} activeClassName="cur">
                  공지사항
                </NavLink>
              </li>
              <li>
                <NavLink to={URL.INFORM_GALLERY} activeClassName="cur">
                  사이트 갤러리
                </NavLink>
              </li>
            </ul>
